 ...
 * on (see gpu_unai.h), so the FrameToRead/FrameToWrite block at the
 * top is compiled out — the pcsxr-360 driver bridge handles
 * LoadImage/StoreImage transfers via psxVuw directly. */
