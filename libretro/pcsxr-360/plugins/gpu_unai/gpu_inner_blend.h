 ...
 *
 * Direct port from upstream gpu_unai/gpu_inner_blend.h.  Only change is
 * pulling in gpu_unai_compat.h so GPU_INLINE / uint_fast16_t resolve
 * cleanly under MSVC PPC.  All blend math is platform-independent
 * (Blargg's bitwise modulo-clamping). */
 ...
 *
 * INPUT:  'uSrc','uDst' input: -bbbbbgggggrrrrr  (bit 16 marker shown as -)
 * OUTPUT: u16 output:           0bbbbbgggggrrrrr
 */
