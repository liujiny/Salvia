...
{
#ifdef LIBRETRO
	// Pacing is driven by the libretro frontend calling retro_run() at the
	// correct cadence. Any FrameCap()/FrameSkip() here would Sleep() inside
	// the emu fiber and fight the frontend-provided frame timing.
	return;
#endif
