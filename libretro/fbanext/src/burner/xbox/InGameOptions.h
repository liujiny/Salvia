...
#define XM_MESSAGE_ON_RESCAN_SHADERS	XM_USER+3
...
class CShaderList : CXuiListImpl
{

public:

	XUI_IMPLEMENT_CLASS(CShaderList, L"BurnShaderList", XUI_CLASS_LIST);
...
protected:
	...
	CXuiCheckbox m_Rotate;
	CXuiCheckbox m_Mirror;
