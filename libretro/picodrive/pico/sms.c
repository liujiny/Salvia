...
// row | col
/* 1. Declaraci�n del array (Ajusta el tama�o si tus constantes superan 256) */
static unsigned char kbd_map[256];

/* 2. Funci�n de inicializaci�n compatible con VS2010 */
...
/* 1. Declaraci�n del array de punteros */
/* Ajusta el tama�o (ej. 16 o 32) seg�n el valor m�ximo de tus constantes PMS_MAP */
static char *mappers[16]; 

/* 2. Funci�n de inicializaci�n */
void init_mappers_names(void)
{
    /* Limpiamos el array para que los �ndices no usados sean NULL */
