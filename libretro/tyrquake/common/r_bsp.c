...
================
*/
void R_RotateBmodel(const entity_t *e)
{
...
================
*/
static void R_RecursiveClipBPoly(const entity_t *e, bedge_t *pedges, mnode_t *pnode,
      msurface_t *psurf)
{
...
================
*/
static void R_RecursiveWorldNode(const entity_t *e, mnode_t *node)
{
   int count, side;
   mplane_t *plane;
   msurface_t *surf;
