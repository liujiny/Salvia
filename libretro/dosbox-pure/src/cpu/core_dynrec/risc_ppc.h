...
// Xbox 360 XDK: ppcintrinsics.h is already included via vs2010_compat.h (forced include)
// Define __icbi as naked function since the XDK doesn't provide it as an intrinsic
// (same approach used by PCSX-R 360's PPC dynarec)
#if defined(_MSC_VER) && defined(_XBOX)
static void __declspec(naked) __dbp_icbi(int offset, const void* base)
{
	__asm {
		icbi r3, r4
		blr
...
static void gen_run_code(void)
{
	...
	// Save r2 (TOC/SDA2 on some ABIs) and r13 (SDA on some ABIs)
	// Xbox 360 XDK may use these; C functions called from generated code could depend on them
	IMM_OP(36, HOST_R2, HOST_R1, 120);   // stw r2, 120(sp)
	IMM_OP(36, HOST_R13, HOST_R1, 124);  // stw r13, 124(sp)
	...
	// Restore r2 and r13 before restoring r26-r31
	IMM_OP(32, HOST_R2, HOST_R1, 120);   // lwz r2, 120(sp)
	IMM_OP(32, HOST_R13, HOST_R1, 124);  // lwz r13, 124(sp)
