static const unsigned char royaltea_palette[64][3] = {
...
static const unsigned char pal_palette[64][3] = {
...
static const unsigned char digital_prime_fbx_palette[64][3] = {
...
static const unsigned char magnum_fbx_palette[64][3] = {
    {0x60,0x60,0x60}, {0x00,0x14,0x8F}, {0x1E,0x02,0x9B}, {0x3F,0x00,0x8A},
    {0x60,0x00,0x60}, {0x66,0x00,0x17}, {0x57,0x0D,0x00}, {0x3C,0x1F,0x00},
    {0x1B,0x33,0x00}, {0x00,0x42,0x00}, {0x00,0x45,0x00}, {0x00,0x3C,0x1F},
    {0x00,0x31,0x5C}, {0x00,0x00,0x00}, {0x00,0x00,0x00}, {0x00,0x00,0x00},
    {0xA6,0xA6,0xA6}, {0x0F,0x4B,0xD4}, {0x41,0x2D,0xEB}, {0x6C,0x1D,0xD9},
    ...
    {0xFF,0xFF,0xFF}, {0x4C,0x9C,0xFF}, {0x72,0x78,0xFF}, {0x9B,0x64,0xFF},
    {0xD9,0x64,0xFF}, {0xF0,0x64,0xB6}, {0xF3,0x7B,0x50}, {0xD5,0x93,0x0F},
    {0xB3,0xAF,0x0C}, {0x78,0xC4,0x03}, {0x41,0xD2,0x32}, {0x34,0xCA,0x76},
    {0x37,0xBC,0xC6}, {0x4A,0x4A,0x4A}, {0x00,0x00,0x00}, {0x00,0x00,0x00},
    {0xFF,0xFF,0xFF}, {0xAE,0xD6,0xFF}, {0xBF,0xC0,0xFF}, {0xCA,0xB9,0xFF},
    {0xE6,0xBE,0xFD}, {0xF5,0xBE,0xE1}, {0xF5,0xC8,0xB9}, {0xF0,0xD7,0xA0},
    {0xE3,0xE0,0x95}, {0xC6,0xEC,0x95}, {0xB5,0xEB,0xA8}, {0xAA,0xE6,0xC3},
    {0xAB,0xE5,0xE7}, {0xB1,0xB1,0xB1}, {0x00,0x00,0x00}, {0x00,0x00,0x00}
};

static const unsigned char smoothv2_fbx_palette[64][3] = {
...
static const unsigned char composite_direct_fbx_palette[64][3] = {
...
static const unsigned char ntsc_hardware_fbx_palette[64][3] = {
...
static const unsigned char restored_wii_vc_palette[64][3] = {
...
static const unsigned char wii_vc_palette[64][3] = {
