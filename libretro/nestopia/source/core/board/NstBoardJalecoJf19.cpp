	...
	namespace Core
	{
		namespace Boards
		{
			namespace Jaleco
			{
				...
				:
				Board (c),
				sound (Sound::Player::Create(*c.apu,c.chips,L"D7756C",board == Type::JALECO_JF19 ? Sound::Player::GAME_MOERO_PRO_YAKYUU_88 : Sound::Player::GAME_UNKNOWN,32))
				{
				}
				...
				NES_POKE_AD(Jf19,8000)
				{
					...
					if (data & 0x80)
						prg.SwapBank<SIZE_16K,0x4000>( data & 0xF );
