...
bool dkb_wildfire_pci_init(struct autoconfig_info *aci) { return false; }
bool grex_init(struct autoconfig_info *aci) { return false; }
bool mediator_init(struct autoconfig_info *aci) { return false; }
bool mediator_init2(struct autoconfig_info *aci) { return false; }
bool prometheus_init(struct autoconfig_info *aci) { return false; }
