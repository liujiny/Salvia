...
static dbool WriteTime(unsigned int time, MEMFILE *midioutput)
{
...
static dbool WriteEndTrack(MEMFILE *midioutput)
{
...
static dbool WritePressKey(byte channel, byte key,
...
static dbool WriteReleaseKey(byte channel, byte key,
                                MEMFILE *midioutput)
{
...
static dbool WritePitchWheel(byte channel, short wheel,
                                MEMFILE *midioutput)
{
...
static dbool WriteChangePatch(byte channel, byte patch,
                                 MEMFILE *midioutput)
{
...
static dbool WriteChangeController_Valued(byte channel,
                                             byte control,
                                             byte value,
                                             MEMFILE *midioutput)
{
...
static dbool WriteChangeController_Valueless(byte channel,
                                                byte control,
                                                MEMFILE *midioutput)
{
...
static dbool ReadMusHeader(MEMFILE *file, musheader *header)
{
  dbool result;
...
dbool mus2mid(MEMFILE *musinput, MEMFILE *midioutput)
{
