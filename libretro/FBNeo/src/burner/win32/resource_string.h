...
#define IDS_INPUT_DETECT_GAMEPADS		(IDS_STRING +   66)
...
#define IDS_MEMCARD_INSERT				(IDS_STRING +  124)
#define IDS_MEMCARD_EJECT				(IDS_STRING +  126)
#define IDS_MEMCARD						(IDS_STRING +  128)
...
#define IDS_SCANNING_IMGS				(IDS_STRING +  874)
