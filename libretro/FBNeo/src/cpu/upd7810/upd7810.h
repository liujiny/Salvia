 ...
 */
extern INT32 (*upd7810_io_callback)(INT32 ioline, INT32 state);
...
enum {
	UPD7810_PORTA=0, UPD7810_PORTB, UPD7810_PORTC, UPD7810_PORTD, UPD7810_PORTF
};

enum {
	UPD7807_PORTA=0, UPD7807_PORTB, UPD7807_PORTC, UPD7807_PORTD, UPD7807_PORTF,
	UPD7807_PORTT
};
