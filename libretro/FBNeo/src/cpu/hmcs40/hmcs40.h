...
// FBNeo Note: ported from .280, 44801 supported.  Jan 2026 -dink
// (Support for others can be easily added if needed)
...
#if 0
void hmcs40_hd44801_init(UINT8 *mcurom);
void hmcs40_reset();
void hmcs40_exit();
void hmcs40_set_irqline(int line, int state);
#endif
