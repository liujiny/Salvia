 ...
 ***************************************************************/
Z180_INLINE void z180_mmu( void )
{
	UINT32 addr, page, bb, cb;
	bb = IO_CBAR & 15;
	cb = IO_CBAR >> 4;
 ...
 ***************************************************************/
Z180_INLINE void RM16( UINT32 addr, PAIR *r )
{
	r->b.l = RM(addr);
	r->b.h = RM(addr+1);
}
 ...
 ***************************************************************/
Z180_INLINE void WM16( UINT32 addr, PAIR *r )
{
	WM(addr,r->b.l);
	WM(addr+1,r->b.h);
}
 ...
 * INC  r8
 ***************************************************************/
Z180_INLINE UINT8 INC(UINT8 value)
{
	UINT8 res = value + 1;
 ...
 * DEC  r8
 ***************************************************************/
Z180_INLINE UINT8 DEC(UINT8 value)
{
	UINT8 res = value - 1;
 ...
 * RLC  r8
 ***************************************************************/
Z180_INLINE UINT8 RLC(UINT8 value)
{
	unsigned res = value;
 ...
 * RRC  r8
 ***************************************************************/
Z180_INLINE UINT8 RRC(UINT8 value)
{
	unsigned res = value;
 ...
 * RL   r8
 ***************************************************************/
Z180_INLINE UINT8 RL(UINT8 value)
{
	unsigned res = value;
	unsigned c = (res & 0x80) ? CF : 0;
 ...
 * RR   r8
 ***************************************************************/
Z180_INLINE UINT8 RR(UINT8 value)
{
	unsigned res = value;
	unsigned c = (res & 0x01) ? CF : 0;
	res = ((res >> 1) | (_F << 7)) & 0xff;
 ...
 * SLA  r8
 ***************************************************************/
Z180_INLINE UINT8 SLA(UINT8 value)
{
	unsigned res = value;
	unsigned c = (res & 0x80) ? CF : 0;
	res = (res << 1) & 0xff;
 ...
 * SRA  r8
 ***************************************************************/
Z180_INLINE UINT8 SRA(UINT8 value)
{
	unsigned res = value;
	unsigned c = (res & 0x01) ? CF : 0;
 ...
 * SLL  r8
 ***************************************************************/
Z180_INLINE UINT8 SLL(UINT8 value)
{
	unsigned res = value;
	unsigned c = (res & 0x80) ? CF : 0;
	res = ((res << 1) | 0x01) & 0xff;
 ...
 * SRL  r8
 ***************************************************************/
Z180_INLINE UINT8 SRL(UINT8 value)
{
	unsigned res = value;
	unsigned c = (res & 0x01) ? CF : 0;
	res = (res >> 1) & 0xff;
 ...
 * RES  bit,r8
 ***************************************************************/
Z180_INLINE UINT8 RES(UINT8 bit, UINT8 value)
{
	return value & ~(1<<bit);
}
 ...
 * SET  bit,r8
 ***************************************************************/
Z180_INLINE UINT8 SET(UINT8 bit, UINT8 value)
{
	return value | (1<<bit);
}
