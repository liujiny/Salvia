...
/*#define cpu_readop16			TMS34010_RDMEM_WORD
#define cpu_readop_arg16    	TMS34010_RDMEM_WORD
#define program_write_word_16le TMS34010_WRMEM_WORD
#define program_read_word_16le  TMS34010_RDMEM_WORD */

#define cpu_readop16(A)		((unsigned)TMS34010ReadWord (A))
#define cpu_readop_arg16(A)		((unsigned)TMS34010ReadWord (A))
#define program_read_word_16le(A)		((unsigned)TMS34010ReadWord (A))
#define program_write_word_16le(A,V)		(TMS34010WriteWord(A,V))
...
#define SMART_IOREG(reg)			(state.IOregs[((state.is_34020) ? (int)REG020_##reg : (int)REG_##reg)])
