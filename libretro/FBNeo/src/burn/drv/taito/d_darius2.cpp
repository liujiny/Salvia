...
{
	UINT32 DrvJoyInit[3] = { 0xe2, 0xff, 0xff };
...
static struct BurnRomInfo Ninjaw1RomDesc[] = {
	{ "b31_30.35",     0x10000, 0x056edd9f, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "b31_43.32",     0x10000, 0x56ae37a6, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "b31_29.34",     0x10000, 0xf2941a37, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "b31_27.31",     0x10000, 0x2f3ff642, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "b31_41.5",      0x20000, 0x0daef28a, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "b31_39.2",      0x20000, 0xe9197c3c, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
static void __fastcall Darius268K1WriteWord(UINT32 a, UINT16 d)
{
	...
	switch (a) {
		...
		case 0x340000:
		case 0x340002: {
			TC0110PCRStep1WordWrite(0, (a & 0x02) >> 1, d);
			return;
		}

		case 0x350000:
		case 0x350002: {
			TC0110PCRStep1WordWrite(1, (a & 0x02) >> 1, d);
			return;
		}

		case 0x360000:
		case 0x360002: {
			TC0110PCRStep1WordWrite(2, (a & 0x02) >> 1, d);
			return;
		}
...
static void __fastcall Darius2d68KWriteWord(UINT32 a, UINT16 d)
{
	...
	switch (a) {
		...
		case 0x400002:
		case 0x400004: {
			TC0110PCRStep1WordWrite(0, (a & 0x06) >> 1, d);
			return;
		}
		...
		case 0x420002:
		case 0x420004: {
			TC0110PCRStep1WordWrite(1, (a & 0x06) >> 1, d);
			return;
		}
...
static INT32 Darius2Init()
{
	...
	TaitoResetFunction = Darius2DoReset;
	TaitoResetFunction();
...
struct BurnDriver BurnDrvNinjaw1 = {
