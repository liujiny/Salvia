...
static struct BurnInputInfo MplanetsInputList[] = {
	...
	{"Reset",			BIT_DIGITAL,	&DrvReset,      "reset"     },
	{"Select",			BIT_DIGITAL,	DrvJoy1 + 6,    "diag"      },
	{"Dip A",			BIT_DIPSWITCH,	DrvDip + 0,     "dip"       },
	{"Dip B",			BIT_DIPSWITCH,	DrvDip + 1,     "dip"       },
};
...
static struct BurnInputInfo ScrewlooInputList[] = {
	...
	{"Right Stick Up",	BIT_DIGITAL,	DrvJoy2 + 3,	"p1 up 2"	},
	{"Right Stick Down",BIT_DIGITAL,	DrvJoy2 + 2,	"p1 down 2"	},
	{"Right Stick Left",BIT_DIGITAL,	DrvJoy2 + 1,	"p1 left 2"	},
	{"Right Stick Right",BIT_DIGITAL,	DrvJoy2 + 0,	"p1 right 2"},
...
static struct BurnInputInfo Stooges3InputList[] = {
	...
	{"P1 Left",			BIT_DIGITAL,	DrvJoy5 + 3,	"p1 left"	},
...
static struct BurnInputInfo ReactorInputList[] = {
	...
	{"Reset",			BIT_DIGITAL,	&DrvReset,		"reset"		},
	{"Select",			BIT_DIGITAL,	DrvJoy1 + 0,    "diag"      },
	{"Dip A",			BIT_DIPSWITCH,	DrvDip + 0,		"dip"		},
	{"Dip B",			BIT_DIPSWITCH,	DrvDip + 1,		"dip"		},
};
...
static struct BurnDIPInfo MplanetsDIPList[]=
{
	...
	{0x00, 0x01, 0x02, 0x00, "10000"					},
	{0x00, 0x01, 0x02, 0x02, "12000"					},

	{0   , 0xfe, 0   ,    2, "Allow Round Select"   	},
	{0x00, 0x01, 0x08, 0x00, "No"		        		},
	{0x00, 0x01, 0x08, 0x08, "Yes"		        		},

	{0   , 0xfe, 0   ,    4, "Coinage"					},
	{0x00, 0x01, 0x14, 0x04, "2 Coins 1 Credit"			},
	{0x00, 0x01, 0x14, 0x00, "1 Coin  1 Credit"			},
	{0x00, 0x01, 0x14, 0x10, "1 Coin  2 Credits"    	},
	{0x00, 0x01, 0x14, 0x14, "Free Play"				},

	{0   , 0xfe, 0   ,    2, "Lives"					},
	{0x00, 0x01, 0x20, 0x00, "3"		        		},
	{0x00, 0x01, 0x20, 0x20, "5"		        		},
...
static struct BurnDIPInfo QbertqubDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    13, "Coinage"					},
	{0x00, 0x01, 0x35, 0x24, "A 2/1 B 2/1"				},
	{0x00, 0x01, 0x35, 0x14, "A 1/1 B 4/1"				},
	{0x00, 0x01, 0x35, 0x30, "A 1/1 B 3/1"				},
	{0x00, 0x01, 0x35, 0x10, "A 1/1 B 2/1"				},
	{0x00, 0x01, 0x35, 0x00, "A 1/1 B 1/1"				},
	{0x00, 0x01, 0x35, 0x11, "A 2/3 B 2/1"				},
	{0x00, 0x01, 0x35, 0x15, "A 1/2 B 3/1"				},
	{0x00, 0x01, 0x35, 0x20, "A 1/2 B 2/1"				},
	{0x00, 0x01, 0x35, 0x21, "A 1/2 B 1/1"				},
	{0x00, 0x01, 0x35, 0x31, "A 1/2 B 1/5"				},
	{0x00, 0x01, 0x35, 0x04, "A 1/3 B 2/1"				},
	{0x00, 0x01, 0x35, 0x05, "A 1/3 B 1/1"				},
	{0x00, 0x01, 0x35, 0x35, "Free Play"				},

	{0   , 0xfe, 0   ,    2, "1st Bonus Life"			},
	{0x00, 0x01, 0x02, 0x00, "10000"					},
	{0x00, 0x01, 0x02, 0x02, "15000"					},

	{0   , 0xfe, 0   ,    2, "Additional Bonus Life"	},
	{0x00, 0x01, 0x40, 0x00, "20000"					},
	{0x00, 0x01, 0x40, 0x40, "25000"					},

	{0   , 0xfe, 0   ,    2, "Difficulty"				},
	{0x00, 0x01, 0x80, 0x00, "Normal"					},
	{0x00, 0x01, 0x80, 0x80, "Hard"		        		},
...
static struct BurnDIPInfo InsectorDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    2, "Bonus Life"				},
	{0x00, 0x01, 0x01, 0x00, "25k 75k and every 50k"	},
	{0x00, 0x01, 0x01, 0x01, "30k 90k and every 60k"	},
	...
	{0   , 0xfe, 0   ,    4, "Coinage"					},
	{0x00, 0x01, 0x50, 0x40, "2 Coins 1 Credits"		},
	{0x00, 0x01, 0x50, 0x50, "2 Coins 2 Credits"		},
	{0x00, 0x01, 0x50, 0x00, "1 Coin  1 Credits"		},
	{0x00, 0x01, 0x50, 0x10, "1 Coin  2 Credits"		},
...
static struct BurnDIPInfo ArgusgDIPList[]=
{
	...
	{0x00, 0x01, 0x22, 0x00, "15000"					},
	{0x00, 0x01, 0x22, 0x02, "20000"					},
	{0x00, 0x01, 0x22, 0x20, "25000"					},
	{0x00, 0x01, 0x22, 0x22, "30000"					},

	{0   , 0xfe, 0   ,    4, "Initial Humans"			},
	{0x00, 0x01, 0x14, 0x00, "4"						},
	{0x00, 0x01, 0x14, 0x10, "6"						},
	{0x00, 0x01, 0x14, 0x04, "8"						},
	{0x00, 0x01, 0x14, 0x14, "10"						},
...
static struct BurnDIPInfo KrullDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    2, "Difficulty"				},
	{0x00, 0x01, 0x02, 0x00, "Normal"					},
	{0x00, 0x01, 0x02, 0x02, "Hard"						},

	{0   , 0xfe, 0   ,    2, "Lives"					},
	{0x00, 0x01, 0x08, 0x00, "3"						},
	{0x00, 0x01, 0x08, 0x08, "5"						},

	{0   , 0xfe, 0   ,    4, "Coinage"					},
	{0x00, 0x01, 0x14, 0x04, "2 Coins 1 Credits"		},
	{0x00, 0x01, 0x14, 0x00, "1 Coin  1 Credits"		},
	{0x00, 0x01, 0x14, 0x10, "1 Coin  2 Credits"		},
	{0x00, 0x01, 0x14, 0x14, "Free Play"				},

	{0   , 0xfe, 0   ,    2, "Hexagon"					},
	{0x00, 0x01, 0x20, 0x00, "Roving"					},
	{0x00, 0x01, 0x20, 0x20, "Stationary"				},

	{0   , 0xfe, 0   ,    4, "Bonus Life"				},
	{0x00, 0x01, 0xc0, 0x40, "30k 60k and every 30k"	},
	{0x00, 0x01, 0xc0, 0x00, "30k 80k and every 50k"	},
	{0x00, 0x01, 0xc0, 0x80, "40k 90k and every 50k"	},
	{0x00, 0x01, 0xc0, 0xc0, "50k 125k and every 75k"	},
...
static struct BurnDIPInfo CurvebalDIPList[]=
{
	...
	{0x00, 0x01, 0x08, 0x08, "1 Credit"					},
	{0x00, 0x01, 0x08, 0x00, "2 Credits"				},

	{0   , 0xfe, 0   ,    4, "Difficulty"				},
	{0x00, 0x01, 0x11, 0x00, "Easy"						},
	{0x00, 0x01, 0x11, 0x10, "Medium"					},
	{0x00, 0x01, 0x11, 0x01, "Hard"						},
	{0x00, 0x01, 0x11, 0x11, "Very Hard"				},

	{0   , 0xfe, 0   ,    2, "Coins"					},
	{0x00, 0x01, 0x20, 0x00, "Normal"					},
	{0x00, 0x01, 0x20, 0x20, "French"					},

	{0   , 0xfe, 0   ,    13, "Coinage"					},
	{0x00, 0x01, 0xc2, 0x42, "A 3/1 B 1/2"				},
	{0x00, 0x01, 0xc2, 0x42, "A 4/1 B 1/1"				},
	{0x00, 0x01, 0xc2, 0x82, "A 1/5 B 1/2"				},
	{0x00, 0x01, 0xc2, 0x82, "A 3/1 B 1/1"				},
	{0x00, 0x01, 0xc2, 0x02, "A 2/1 B 2/3"				},
	{0x00, 0x01, 0xc2, 0x02, "A 2/1 B 1/1"				},
	{0x00, 0x01, 0xc2, 0xc0, "A 2/1 B 2/1"				},
	{0x00, 0x01, 0xc2, 0x80, "A 1/1 B 1/2"				},
	{0x00, 0x01, 0xc2, 0x80, "A 2/1 B 1/2"				},
	{0x00, 0x01, 0xc2, 0x40, "A 1/1 B 1/3"				},
	{0x00, 0x01, 0xc2, 0x40, "A 2/1 B 1/3"				},
	{0x00, 0x01, 0xc2, 0x00, "A 1/1 B 1/1"				},
	{0x00, 0x01, 0xc2, 0xc2, "Free Play"				},
...
static struct BurnDIPInfo TylzDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Coinage"					},
	{0x00, 0x01, 0x11, 0x01, "2 Coins 1 Credits"		},
	{0x00, 0x01, 0x11, 0x00, "1 Coin  1 Credits"		},
	{0x00, 0x01, 0x11, 0x10, "1 Coin  2 Credits"		},
	{0x00, 0x01, 0x11, 0x11, "Free Play"				},

	{0   , 0xfe, 0   ,    4, "Bonus Life"				},
	{0x00, 0x01, 0x22, 0x00, "15k 35k and every 20k"	},
	{0x00, 0x01, 0x22, 0x20, "15k 45k and every 30k"	},
	{0x00, 0x01, 0x22, 0x02, "20k 55k and every 35k"	},
	{0x00, 0x01, 0x22, 0x22, "20k 60k and every 40k"	},

	{0   , 0xfe, 0   ,    4, "Difficulty"				},
	{0x00, 0x01, 0xc0, 0x00, "Easy"						},
	{0x00, 0x01, 0xc0, 0x40, "Normal Easy"				},
	{0x00, 0x01, 0xc0, 0x80, "Normal Hard"				},
	{0x00, 0x01, 0xc0, 0xc0, "Hard"						},
...
static struct BurnDIPInfo KngtmareDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    3, "Coinage"					},
	{0x00, 0x01, 0x11, 0x10, "2 Coins 1 Credits"		},
	{0x00, 0x01, 0x11, 0x11, "1 Coin  1 Credits"		},
	{0x00, 0x01, 0x11, 0x01, "1 Coin  2 Credits"		},
...
static struct BurnDIPInfo ScrewlooDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Coinage"					},
	{0x00, 0x01, 0x50, 0x00, "2 Coins 1 Credits"		},
	{0x00, 0x01, 0x50, 0x10, "2 Coins 2 Credits"		},
	{0x00, 0x01, 0x50, 0x40, "1 Coin  1 Credits"		},
	{0x00, 0x01, 0x50, 0x50, "1 Coin  2 Credits"		},

	{0   , 0xfe, 0   ,    2, "1st Bonus Hand at"		},
	{0x00, 0x01, 0x20, 0x00, "25000"					},
	{0x00, 0x01, 0x20, 0x20, "50000"					},
...
static struct BurnDIPInfo WizwarzDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Bonuses"					},
	{0x00, 0x01, 0x09, 0x00, "Life 20k,50k every 30k / Mine 10k,25k every 15k"	},
	{0x00, 0x01, 0x09, 0x08, "Life 20k,55k every 35k / Mine 10k,30k every 20k"	},
	{0x00, 0x01, 0x09, 0x01, "Life 25k,60k every 35k / Mine 15k,35k every 20k"	},
	{0x00, 0x01, 0x09, 0x09, "Life 30k,40k every 40k / Mine 15k,40k every 25k"	},
...
static struct BurnDIPInfo VidvinceDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Coinage"					},
	{0x00, 0x01, 0x09, 0x09, "3 Coins 1 Credits"		},
	{0x00, 0x01, 0x09, 0x08, "2 Coins 1 Credits"		},
	{0x00, 0x01, 0x09, 0x01, "1 Coin  1 Credits"		},
	{0x00, 0x01, 0x09, 0x00, "Free Play"				},

	{0   , 0xfe, 0   ,    2, "Lives"					},
	{0x00, 0x01, 0x02, 0x00, "3"						},
	{0x00, 0x01, 0x02, 0x02, "5"						},

	{0   , 0xfe, 0   ,    4, "Bonus Life"				},
	{0x00, 0x01, 0x14, 0x00, "10000"					},
	{0x00, 0x01, 0x14, 0x04, "20000"					},
	{0x00, 0x01, 0x14, 0x10, "30000"					},
	{0x00, 0x01, 0x14, 0x14, "40000"					},
...
static struct BurnDIPInfo Stooges3DIPList[]=
{
	...
	{0x00, 0x01, 0xc0, 0xc0, "10k 20k and every 10k"	},
	{0x00, 0x01, 0xc0, 0x00, "20k 40k and every 20k"	},
	{0x00, 0x01, 0xc0, 0x40, "10k 30k and every 20k"	},
	{0x00, 0x01, 0xc0, 0x80, "20k 30k and every 10k"	},
...
static struct BurnDIPInfo ReactorDIPList[]=
{
	...
	{0x00, 0x01, 0x02, 0x00, "10"						},
	{0x00, 0x01, 0x02, 0x02, "15"						},
	...
	{0   , 0xfe, 0   ,    2, "Coinage"					},
	{0x00, 0x01, 0x20, 0x00, "2 Coins 1 Credits"		},
	{0x00, 0x01, 0x20, 0x20, "1 Coin  1 Credits"		},

	{0   , 0xfe, 0   ,    4, "Bonus Life"				},
	{0x00, 0x01, 0xc0, 0x00, "10000"					},
	{0x00, 0x01, 0xc0, 0x40, "12000"					},
	{0x00, 0x01, 0xc0, 0xc0, "15000"					},
