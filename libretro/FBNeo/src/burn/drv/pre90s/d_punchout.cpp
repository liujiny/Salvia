...
// Punch-Out!! (Rev A, harder)

static struct BurnRomInfo punchoutahRomDesc[] = {
	{ "chp1-c.8l",			0x2000, 0xc552c3c1, 1 | BRF_PRG | BRF_ESS }, //  0 Z80 Code
	{ "chp1-c.8k",			0x2000, 0xf2907314, 1 | BRF_PRG | BRF_ESS }, //  1
	{ "chp1-c.8j",			0x2000, 0x7a7f870e, 1 | BRF_PRG | BRF_ESS }, //  2
	{ "chp1-c.8h",			0x2000, 0x5d8123d7, 1 | BRF_PRG | BRF_ESS }, //  3
	{ "chp1-c.8f",			0x4000, 0x687010a7, 1 | BRF_PRG | BRF_ESS }, //  4
...
STD_ROM_PICK(punchoutah)
STD_ROM_FN(punchoutah)

struct BurnDriver BurnDrvPunchoutah = {
	"punchoutah", "punchout", NULL, NULL, "1984",
	"Punch-Out!! (Rev A, harder)\0", NULL, "Nintendo", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 1, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	NULL, punchoutahRomInfo, punchoutahRomName, NULL, NULL, NULL, NULL, PunchoutInputInfo, PunchoutDIPInfo,
	PunchoutaInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 448, 4, 6
};
