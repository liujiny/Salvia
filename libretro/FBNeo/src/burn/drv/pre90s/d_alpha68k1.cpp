...
{
	DIP_OFFSET(0x1f)
	{0x00, 0xff, 0xff, 0x73, NULL						},
	{0x01, 0xff, 0xff, 0x00, NULL						},

	{0   , 0xfe, 0   ,    4, "Coin B"					},
	{0x00, 0x01, 0x03, 0x03, "1 Coin  2 Credits"		},
	{0x00, 0x01, 0x03, 0x01, "1 Coin  3 Credits"		},
	{0x00, 0x01, 0x03, 0x02, "1 Coin  4 Credits"		},
	{0x00, 0x01, 0x03, 0x00, "1 Coin  6 Credits"		},

	{0   , 0xfe, 0   ,    4, "Coin A"					},
	{0x00, 0x01, 0x0c, 0x0c, "4 Coins 1 Credits"		},
	...
	{0x00, 0x01, 0x30, 0x00, "Default Time"				},
	{0x00, 0x01, 0x30, 0x20, "+10 Seconds"				},
	{0x00, 0x01, 0x30, 0x10, "+20 Seconds"				},
	{0x00, 0x01, 0x30, 0x30, "+30 Seconds"				},

	{0   , 0xfe, 0   ,    3, "Match Type"				},
	{0x00, 0x01, 0xc0, 0x80, "A to B"					},
	{0x00, 0x01, 0xc0, 0x00, "A to C"					},
	{0x00, 0x01, 0xc0, 0x40, "A to E"					},
	...
	{0x01, 0x01, 0x30, 0x10, "Win Match Against CPU (Cheat)"},
	{0x01, 0x01, 0x30, 0x30, "Freeze"					},

	{0   , 0xfe, 0   ,    2, "Language"					},
	{0x01, 0x01, 0x40, 0x00, "English"					},
	{0x01, 0x01, 0x40, 0x40, "Japanese"					},
...
static struct BurnDIPInfo TnextspcDIPList[]=
{
	...
	{0x00, 0x01, 0x04, 0x04, "2nd Extend ONLY"			},
	{0x00, 0x01, 0x04, 0x00, "Every Extend"				},

	{0   , 0xfe, 0   ,    4, "Coinage"					},
	{0x00, 0x01, 0x30, 0x30, "A 1C/1C B 1C/2C"			},
	{0x00, 0x01, 0x30, 0x20, "A 2C/1C B 1C/3C"			},
	{0x00, 0x01, 0x30, 0x10, "A 3C/1C B 1C/5C"			},
	{0x00, 0x01, 0x30, 0x00, "A 4C/1C B 1C/6C"			},

	{0   , 0xfe, 0   ,    4, "Lives"					},
	{0x00, 0x01, 0xc0, 0xc0, "2"						},
	...
	{0x01, 0x01, 0x04, 0x00, "Freeze"					},
	{0x01, 0x01, 0x04, 0x04, "Infinite Lives (Cheat)"	},

	{0   , 0xfe, 0   ,    2, "Demo Sound/Game Mode"		},
	{0x01, 0x01, 0x08, 0x08, "Demo Sounds"				},
	{0x01, 0x01, 0x08, 0x00, "Game Mode"				},

	{0   , 0xfe, 0   ,    4, "Bonus Life"				},
	{0x01, 0x01, 0x30, 0x30, "100000 200000"			},
	{0x01, 0x01, 0x30, 0x20, "150000 300000"			},
	{0x01, 0x01, 0x30, 0x10, "300000 500000"			},
