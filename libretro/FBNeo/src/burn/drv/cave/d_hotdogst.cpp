...
static UINT8 __fastcall hotdogstReadByte(UINT32 sekAddress)
{
	switch (sekAddress) {
		case 0xc80002:
...
static void __fastcall hotdogstWriteByte(UINT32 sekAddress, UINT8 byteValue)
{
	switch (sekAddress) {
		case 0xd00000:
			{
...
static UINT16 __fastcall hotdogstReadWord(UINT32 sekAddress)
{
	switch (sekAddress) {
		case 0xa80000:
		case 0xa80002: {
...
static void __fastcall hotdogstWriteWord(UINT32 sekAddress, UINT16 wordValue)
{
	switch (sekAddress) {
		case 0xa80000:
		...
		default: {
			if ((sekAddress & 0xff0000) != 0xa80000) // unused crtc/vregs
...
static UINT8 __fastcall hotdogstZIn(UINT16 nAddress)
{
	nAddress &= 0xFF;
...
{
	MSM6295SetBank(0, MSM6295ROMSrc + 0x20000 * DrvOkiBank1, 0x00000, 0x1ffff);
	MSM6295SetBank(0, MSM6295ROMSrc + 0x20000 * DrvOkiBank2, 0x20000, 0x3ffff);
}

static void Z80_bank(UINT8 nValue)
{
...
static void __fastcall hotdogstZOut(UINT16 nAddress, UINT8 nValue)
{
	nAddress &= 0xFF;
...
static UINT8 __fastcall hotdogstZRead(UINT16 a)
{
	switch (a) {
		default: {
...
static void __fastcall hotdogstZWrite(UINT16 a, UINT8 d)
{
	switch (a) {
		default: {
...
struct BurnDriver BurnDrvhotdogst = {
	...
	"Hotdog Storm - The First Supersonics (korea)\0", NULL, "Marble (Ace International license)", "Cave",
	NULL, NULL, NULL, NULL,
