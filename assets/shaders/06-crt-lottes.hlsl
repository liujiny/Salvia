 ...
 *   - Mask uses vpos (VPOS semantic) en vez de vTexCoord/OutputSize.zw.       */
 ...
 #ifdef XBOX_CRT_FAST
 /* Xenos fast path: gamma 2.0/sqrt closely tracks 2.2 while removing twelve
    vector transcendental pow operations per output pixel (11 taps + output). */
