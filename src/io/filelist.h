...
class FileList {
public:
    // M�todo para guardar el vector en un archivo
    static bool guardarVector(const std::string& nombreArchivo, const std::vector<std::string>& datos) {
        ...
        // Iterar sobre el vector y escribir cada string en una l�nea nueva
	...
	// Carga las l�neas de un archivo en un vector de strings
    static bool cargarVector(const std::string& nombreArchivo, std::vector<std::string>& datos) {
        ...
        // Leemos l�nea por l�nea hasta el final del archivo
